      ...
      <form class="d-flex">
		...
		<div class="container">
			<div class="row">
				<div class="col">
				  <!-- Content here -->
				  <form action="http://localhost/northit/suplier/processsuplier.php"method="POST">
				  ...
				  <div class="form-group">
				    ...
				    <input type="text" class="form-control" id="" aria-describedby="" placeholder="Enter category name" name="name" required>
				  	...
				  	<div class="form-group">
				    <p><span class="text-danger">* required field</span></p>
				    <label for="">suplier address</label>
				    <input type="text" class="form-control" id="" aria-describedby="" placeholder="Enter suplier address" name="address" required>
				  </div>
					  ...
					  <table class="table table-hover">
						  ...
						  <?php 
						    ...
						    <tr>
						      ...
						      <td>
						      	<a class="btn-btn-danger" href="deletesuplier.php?id=<?php echo $row['id']?>"><button>delete</button></a>
