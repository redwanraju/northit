      ...
      <form class="d-flex">
		...
		<div class="container">
			<div class="row">
				<div class="col">
				  <!-- Content here -->
				  <form action="http://localhost/northit/post/processspost.php"method="POST">
				    ...
				    <input type="text" class="form-control" id="" aria-describedby="" placeholder="Email" name="email" required>
				    </div>
            ...
            <div class="form-group ">
				    <label for="con password">confirm password
				    <span class="text-danger"></span>
				   </label>
				    <input type="password" class="form-control" id="" aria-describedby="" placeholder="confirm password" name="con_password" required>
				    </div>
