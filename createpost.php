			...
			<div class="row">
				<div class="col">
				  ...
				  <form action="http://localhost/northit/post/processspost.php"method="POST">
					...
					<label for="inputState">পোস্ট ক্যাটেগরি</label>
				    ...
				    <input type="text" class="form-control" id="" aria-describedby="" placeholder="post title" name="title" required>
				    </div>
				  <div class="form-group">
					  ...
					  <table class="table table-hover">
						  ...
						  <?php 
							...
							<td><?php echo $row['description']?></td>
							  ...
							  <td>
						      	<a class="btn-btn-danger" href="deletepost.php?id=<?php echo $row['id']?>"><button>delete</button></a>
							</td>
						    </tr>
						     <?php  } ?>
						  </tbody>
